package TPO_DisenoOrientadoObjetos;
...
public class CompletoTest {
    ...
    public void testDividirExpensa(){
        ...
        verify(this.unidadA).anadirExpensa(gastosOrdinarios * porcentajeUnidadA,gastosExtraordinarios * porcentajeUnidadA, deudaUnidadA);

        verify(this.unidadB).anadirExpensa(gastosOrdinarios * porcentajeUnidadB,gastosExtraordinarios * porcentajeUnidadB, deudaUnidadB);
    }
